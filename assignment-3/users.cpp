...
bool users::toggle_emergency() {
    emergency = !emergency;
    std::cout << "Emergency toggled: " << emergency << std::endl;
    return emergency;
}

bool users::emergency_state() {
    return emergency;
}
...
Guest::Guest(std::string first_name, std::string last_name) : User(first_name, last_name) {};